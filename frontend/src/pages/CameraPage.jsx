...
export default function CameraPage() {
  ...
  return (
    <div className="flex min-h-[min(100vh-2rem,780px)] flex-1 flex-col bg-camera-bg">
      ...
      <div className="relative mx-4 mb-0 mt-2 flex min-h-[320px] flex-1 items-center justify-center overflow-hidden rounded-2xl bg-[#0b1222]">
        {previewUrl ? (
      ...
      <div className="mt-auto flex shrink-0 flex-col items-center gap-4 rounded-t-[20px] bg-white px-6 pb-7 pt-5 shadow-[0_-8px_30px_rgba(0,0,0,0.12)]">
        <input
          ref={captureRef}
          id={captureId}
          type="file"
        ...
        >
          <svg viewBox="0 0 24 24" width="28" height="28" fill="none" aria-hidden>
            ...
            />
            <path
              d="M5 9h2l1-2h8l1 2h2a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-8a2 2 0 0 1 2-2Z"
              stroke="currentColor"
              strokeWidth="2"
              strokeLinejoin="round"
            />
